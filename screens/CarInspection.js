...
const CarInspection = ({ navigation }) => {
  ...
  const getdata = ({ brandName, modelName, fuelType }) => {
    ...
    fetch("https://digi-servizzy-backend.herokuapp.com/api/get-car-inspection-pack", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        brandName: brandName,
      ...
      .then((data) => {
        ...
        const filterdata = data.data.filter((x) => Object.keys(Check).includes(x.title))
    ...
    <View style={{marginBottom:59}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* <Servcard
              ...
              navigation={navigation}
            /> */}
             <Text style={{ fontWeight: "bold",width:"84%" , alignSelf:"center",marginBottom:8,justifyContent:"flex-end"}}>Are you facing an issue ? Call our 24/7 assistance - 8286 777 555</Text>
      </ScrollView>
    </View>
  );
};
